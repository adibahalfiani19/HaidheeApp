...
<head>
    ...
    <title>Pengguna (Admin) - Haidhee</title>
...
<div class="container mx-auto mt-14 px-6 md:px-14">
    ...
    <h2 class="text-gray-600 font-semibold mb-6">Jumlah Pengguna: {{ $userCount }}</h2>
        ...
        <table class="min-w-full bg-white">
            <thead class="bg-[#5F7E78] text-white">
                <tr>
                    ...
                    {{-- <th class="py-2 px-2">Nomor WhatsApp</th> --}}
                    <th class="py-2 px-2">Tanggal Buat Akun</th> <!-- Tambahkan kolom ini -->
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    {{-- <td class="py-2 px-4 text-center">{{ $user->whatsapp_number }}</td> --}}
                    <td class="py-2 px-4 text-center">{{ \Carbon\Carbon::parse($user->created_at)->format('d F Y') }}</td> <!-- Format Tanggal -->
