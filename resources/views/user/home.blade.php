...
<head>
    ...
    <style>
        /* Header jika ada Notifikasi */
        .header-with-notification {
            position: fixed;
            top: 60px; /* Geser ke bawah 50px untuk memberi ruang pada notifikasi */
            left: 0;
            right: 0;
        ...
        /* Header Normal (tanpa Notifikasi) */
        .header-default {
            position: fixed;
            top: 0; /* Kembali mepet ke atas */
            left: 0;
            right: 0;
            background-color: rgba(255, 255, 255, 1);
            backdrop-filter: blur(10px);
        ...
        /* Body jika Notifikasi Muncul */
        .body-with-notification {
            padding-top: 110px; /* Header + Notifikasi */
        }

        /* Body Normal (Tanpa Notifikasi) */
        .body-default {
            padding-top: 60px; /* Hanya Header */
        }
...
<body class="font-poppins bg-gray-100 {{ $hasPendingPrayers ? 'body-with-notification' : 'body-default' }}">
    <!-- Notifikasi -->
    @if($hasPendingPrayers)
    <div class="notification-bar">
        <i class="fas fa-exclamation-circle mr-1"></i>
        Kamu masih punya salat yang harus diqada! 
        <a href="{{ route('riwayat.menstruasi') }}" class="underline text-red-600 hover:text-red-800">
            Cek detail di menu Riwayat
        </a>
    </div>
    @endif

<!-- Header -->
<header class="bg-white shadow-md py-6 rounded-b-3xl {{ $hasPendingPrayers ? 'header-with-notification' : 'header-default' }}">
    {{-- Header Content --}}
    <div class="container mx-auto flex justify-between items-center px-6 md:px-14">
        ...
        <nav class="hidden lg:flex items-center space-x-6 ml-auto">
            <ul class="flex space-x-6">
                <li><a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'text-[#D4BE83]' : 'text-gray-600 hover:text-[#D4BE83]' }}">Beranda</a></li>
...
<div id="sidebar">
    ...
    <div class="p-4">
        ...
        @auth
            ...
            <a href="{{ route('profile') }}" class="block text-center text-[#5F7E78] border border-[#5F7E78] px-4 py-2 rounded-xl hover:bg-teal-50 mb-4">Profil</a>
...
<!-- Feature Section -->
<section class="feature-section text-center pt-10 pb-16">
    <div class="container mx-auto px-6 md:px-14">
        <h2 class="text-2xl font-bold text-gray-800 mb-12">Apa saja yang bisa kamu dapatkan di Haidhee?</h2>
