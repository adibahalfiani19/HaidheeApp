...
<div class="container mx-auto mt-2 py-10 px-4">
    <div class="content-container">
        ...
        <div class="article-meta">
            <span>Ditulis oleh {{ $article->author }}</span><br>
            <span>Dipublikasikan pada {{ \Carbon\Carbon::parse($article->published_date)->format('d M Y') }}</span>
        </div>

        {{-- Gambar utama artikel --}}
        <img src="{{ asset('storage/' . $article->image) }}" alt="Gambar Artikel" class="article-image">
        ...
        {{-- Tombol Kembali --}}
        <a href="{{ route('articles') }}" class="back-button">← Kembali ke Daftar Artikel</a>
    </div>
</div>
